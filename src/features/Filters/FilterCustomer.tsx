...
const FilterCustomer: React.FC = () => {
  return (
    <Box className='customer-page__list__filters'>
      <Box className='filters--filter-top'>
        <CustomButton
      ...
      <Box className='filters--filter-bottom'>
        <Search placeholder='Tìm kiếm theo mã khách hàng, tên khách hàng và số điện thoại' />
        <Box className='filters--filter-bottom__options'>
